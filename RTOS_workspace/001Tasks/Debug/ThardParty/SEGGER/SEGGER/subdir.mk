...
ThardParty/SEGGER/SEGGER/%.o ThardParty/SEGGER/SEGGER/%.su: ../ThardParty/SEGGER/SEGGER/%.c ThardParty/SEGGER/SEGGER/subdir.mk
...
ThardParty/SEGGER/SEGGER/%.o: ../ThardParty/SEGGER/SEGGER/%.S ThardParty/SEGGER/SEGGER/subdir.mk
	arm-none-eabi-gcc -mcpu=cortex-m4 -g3 -DDEBUG -c -I"C:/mari_workspace/StudyRTOS/RTOS_workspace/001Tasks/ThardParty/SEGGER/Config" -x assembler-with-cpp -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" --specs=nano.specs -mfpu=fpv4-sp-d16 -mfloat-abi=hard -mthumb -o "$@" "$<"

clean: clean-ThardParty-2f-SEGGER-2f-SEGGER

clean-ThardParty-2f-SEGGER-2f-SEGGER:
	-$(RM) ./ThardParty/SEGGER/SEGGER/SEGGER_RTT.d ./ThardParty/SEGGER/SEGGER/SEGGER_RTT.o ./ThardParty/SEGGER/SEGGER/SEGGER_RTT.su ./ThardParty/SEGGER/SEGGER/SEGGER_RTT_ASM_ARMv7M.d ./ThardParty/SEGGER/SEGGER/SEGGER_RTT_ASM_ARMv7M.o ./ThardParty/SEGGER/SEGGER/SEGGER_RTT_printf.d ./ThardParty/SEGGER/SEGGER/SEGGER_RTT_printf.o ./ThardParty/SEGGER/SEGGER/SEGGER_RTT_printf.su ./ThardParty/SEGGER/SEGGER/SEGGER_SYSVIEW.d ./ThardParty/SEGGER/SEGGER/SEGGER_SYSVIEW.o ./ThardParty/SEGGER/SEGGER/SEGGER_SYSVIEW.su
